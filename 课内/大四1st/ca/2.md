...
* No feedback in pure combinational logic 纯组合逻辑中没有反馈
...
Not necessary to consider intermediate signal values in combinational logic **无需考虑组合逻辑中的中间信号值**
...
## 如何设计？Designing the 1-bit register
