...
* [Analysing Issues - 建立论题](#analysing-issues---建立论题)
...
* **pilot essay** - 10.01 16:30
  ...
  * **结构**
    ...
    * argument 【论点，表明能理解professional issues】
      * 分析问题为构建论点的出发点
      ...
      * In your argument, discuss the proposition. Present argu-ments and evidence both for and against the proposition.**在你的论证中，讨论这个命题。提出【支持和反对】这个命题的论据/论点和证据**。
      * **应收集的相关evidence**
      ...
      * 比如：
        ...
        * 为什么这样设计，为什么否定其他设计
        * 为什么选择该算法..否定其他
      * **能够引导决策** employer's decision making
        * 选择什么市场
        * 选择什么技术
        * 产品特性？
        * 产品能交付了吗？
...
# Analysing Issues - 建立论题

* To construct an argument on a given topic, first analyse the issues systematically.为了建构一个论题，首先要系统地**分析这些问题**
